...
- name: Google Cloud Dataflow API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-dataflow/master/_listings/google-dataflow/v1b3-projects-projectid-templates-launch-post.md
x-common:
- type: x-code
